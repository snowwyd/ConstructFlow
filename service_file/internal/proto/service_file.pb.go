...
type FileResponse struct {
	...
	DirectoryId   uint64                 `protobuf:"varint,4,opt,name=directory_id,json=directoryId,proto3" json:"directory_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FileResponse) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *FileResponse) GetDirectoryId() uint64 {
	if x != nil {
...
var file_service_file_proto_rawDesc = string([]byte{
	...
	0x69, 0x6c, 0x65, 0x49, 0x64, 0x22, 0x6d, 0x0a, 0x0c, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x73,
	...
	,
...
var file_service_file_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_service_file_proto_depIdxs = []int32{
	0, // 0: file.FileService.GetFileByID:input_type -> file.GetFileRequest
	1, // 1: file.FileService.GetFileByID:output_type -> file.FileResponse
