...
var file_service_file_proto_rawDesc = string([]byte{
	...
	0xd0, 0x01, 0x0a, 0x0b, 0x46, 0x69, 0x6c, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	...
	0x73, 0x65, 0x42, 0x17, 0x5a, 0x15, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2d, 0x66, 0x69,
	0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
})
...
var file_service_file_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_service_file_proto_goTypes = []any{
	...
	nil,                             // 6: file.GetFilesResponse.FileNamesEntry
	(*emptypb.Empty)(nil),           // 7: google.protobuf.Empty
}
var file_service_file_proto_depIdxs = []int32{
	2, // 0: file.FileResponse.directory:type_name -> file.DirectoryResponse
	6, // 1: file.GetFilesResponse.file_names:type_name -> file.GetFilesResponse.FileNamesEntry
	...
	1, // 5: file.FileService.GetFileByID:output_type -> file.FileResponse
	7, // 6: file.FileService.UpdateFileStatus:output_type -> google.protobuf.Empty
	5, // 7: file.FileService.GetFilesInfo:output_type -> file.GetFilesResponse
